...
//Config::addConfig($packageNameToUpper.'_TOOLS_ROOT',str_replace(Config::getConfig("SITE_ROOT"),"",
//	Config::getConfig('PACKAGES_ROOT').$packageName."/tools/"));
